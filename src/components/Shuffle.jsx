...
// If it fails to load, we might need an alternative.
// Attempting to import it as suggested by the user.
        ...
        () => {
            ...
            const build = () => {
                ...
                try {
                    ...
                    console.error("GSAP SplitText failed. This is a premium plugin. Animation disabled.", e);
                    setReady(true);
                    return;
                }
